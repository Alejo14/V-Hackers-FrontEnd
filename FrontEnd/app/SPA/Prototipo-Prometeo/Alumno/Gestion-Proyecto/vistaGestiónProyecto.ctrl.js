angular.module('vHackersModule').controller('gestionProyectoACtrl', ['$scope', '$state', '$stateParams', 'gestionProyectoServiceAlumno', '$uibModal',
function($scope, $state, $stateParams, gestionProyectoServiceAlumno, $uibModal){
  var ctrl = this;
  ctrl.titulo = "fafa";
  ctrl.alumnosLista = [];
    ...
    swal({
      ...
      if (proyectoNuevoConfirmado !== "cancelar") {
        ...
        data={
          ...
          gestionProyectoServiceAlumno.registroProyecto(angular.toJson(data)).then(function () {
    ...
    swal({
      ...
      if (proyectoModifConfirmado !== "cancelar") {
        ...
        data={
          ...
          console.log(angular.toJson(data));
          gestionProyectoServiceAlumno.modificarProyecto(angular.toJson(data)).then(function () {
            ctrl.exitoso="Proyecto enviado con éxito";
          });
